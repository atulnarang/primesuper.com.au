    ...
    function(e) {
        e.fn.rmAccordion = function(t) {
            ...
            r.addClass("rmAccordion"), t.zebra && e("li:nth-child(even)", r).addClass("zebra"), e("dd", r).css({
                ...
                n.preventDefault(), t.easing ? r.find("dd").slideUp({
                    duration: t.speed,
                    easing: t.easing
                }) : r.find("dd").slideUp({
                    duration: t.speed
                ...
                if (e(this).parent().data("open")) {
                     e(this).parent().next().attr("aria-expanded", "false");
                    var i = e(this);
                ...
                } else e(this).parent().next().attr("aria-expanded", "true"), e(".itemOpen", r).removeClass("itemOpen"), e("dt", r).data("open", !1), t.easing ? e(this).parent().data("open", !0).addClass("itemOpen").next().stop(!0, !0).slideDown({
                    duration: t.speed,
                    easing: t.easing
...
rm = {
    init: function() {
        navigator.userAgent.toLowerCase().indexOf("ipad") != -1 && $("body").addClass("ipad"), $(document).ready(function() {
            rm.cufon.init(), rm.cufon.ready(), rm.lensFlareBaby(), rm.horrendousCarousel(), rm.accordion.init(), rm.scrollTo.init(), rm.fancybox.init()
        })
    },
    fancybox: {
        init: function() {
