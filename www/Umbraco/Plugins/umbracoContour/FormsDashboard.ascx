        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <ItemTemplate>
                <li>
                    ...
                    class="form">
                    <%# ((Umbraco.Forms.Core.Form)Container.DataItem).Name %></a> <small><a href="../#/contour/framed/<%# HttpUtility.UrlEncode("/umbraco/plugins/umbracocontour/editForm.aspx?guid=").Replace("%2f","%252F")%><%# ((Umbraco.Forms.Core.Form)Container.DataItem).Id %>">
